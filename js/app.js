import "./exercises.js?v=20260414r1";
import { S, initFB } from "./state.js?v=20260414r1";
import { rollingPlanForDate } from "./engine.js?v=20260414r1";
import { bootstrapApp, render } from "./ui.js?v=20260414r1";
